...
class DemoCollectionViewController: UICollectionViewController {
    ...
    let cellHeightArray: [CGFloat] = [40, 400, 240, 540, 60, 70, 30, 100]
    ...
    override func viewDidLoad() {
        ...
        collectionView?.register(UINib(nibName: "DemoCollectionViewCell", bundle: nil), forCellWithReuseIdentifier: reuseIdentifier)
...
extension DemoCollectionViewController: PZImageBoardCollectionViewLayoutDelegate {
